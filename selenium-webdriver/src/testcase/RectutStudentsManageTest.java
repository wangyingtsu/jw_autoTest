...
public class RectutStudentsManageTest extends Base {
	...
	public void createReferrerwithsamename() {
		...
		sleep();
		driver.findElement(By.cssSelector("span.bluebtn30_text")).click();
		String actualerrorMess = driver.findElement(By.id("name_tip"))
				.getText();
	...
	public void mobileNumber() {
		...
		String actualerrorMessage01 = driver
				.findElement(
		...
		String actualerrorMessage02 = driver
				.findElement(
						By.xpath(".//*[@id='J_createCircleBasic']/tbody/tr[3]/td[2]/div/label"))
				.getText();
		...
		String actualerrorMessage03 = driver
				.findElement(
						By.xpath(".//*[@id='J_createCircleBasic']/tbody/tr[3]/td[2]/div/label"))
				.getText();
	...
	public void modifyReferrer() {
		...
		driver.findElement(By.id("name")).sendKeys("萝莉002");
		driver.findElement(
				By.xpath(".//*[@id='J_createCircleBasic']/tbody/tr[2]/td[2]/div/input[2]"))
				.click();
		driver.findElement(By.id("mobile")).clear();
